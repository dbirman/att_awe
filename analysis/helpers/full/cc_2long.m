function [mainData, fullHeader] = cc_2long(e)
main = e{1};
...
mainHeader = {'response'};
% these are pulled from stimulus
stimHeader = {'nocatch'};
...
for s = 1:length(stimHeader)
    mainData(:,end+1) = repmat(main.stimulus.nocatch,size(mainData,1),1);
end
