...
x = 0:.001:1;
maf2t.y = weibull(x,allData.behav.maf{2}.fit.fitparams);
maf2t.t = x(find(maf2t.y>=.816,1));
caf1t.y = weibull(x,allData.behav.caf{1}.fit.fitparams);
caf1t.t = x(find(caf1t.y>=.816,1));
caf2t.y = weibull(x,allData.behav.caf{2}.fit.fitparams);
caf2t.t = x(find(caf2t.y>=.816,1));
maf1t.y = weibull(x,allData.behav.maf{1}.fit.fitparams);
