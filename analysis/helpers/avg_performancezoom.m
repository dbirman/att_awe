...
legend([h1,h5],{'Coherence','Contrast'});


title(sprintf('Psychometric Functions for Cohcon n=%i',length(bSIDs)));
xlabel('Contrast/Coherence (%)');
ylabel('Threshold (%)');
axis([0.1 0.9 0 0.3])
drawPublishAxis

fname = fullfile('C:/Users/Dan/Documents/Box Sync/COHCON_DATA','avg_performance_zoom.pdf');
set(h,'Units','Inches');
pos = get(h,'Position');
