...
%   e.g.: cohcon_predict({'MT'},0.25,0.5,1,'baseline=[0.5,0]','subjects=1');
%
%   Purpose: Predict the cortical response 
%
%   Input arguments:
...
%       baseline (default=[0.25, 0]): [contrast baseline, coherence baseline]
%       subjects (default=0): Set to 1 to get individual subject data

baseline=[0.25 0];
subjects=0;
getArgs(varargin,{'baseline=[0.25 0]','subjects=0'});
