function fit = fitCCBehavControlModel_fmri(adata,sigmaval,model,confit,cohfit,lapserate,crossval)
% CCBehavModel
%
...
options = optimoptions('fmincon','Algorithm','active-set','TolFun',5,'TolCon',5,'Display','off'); % set a limit or it goes on foreeeeeeeeeeeever
